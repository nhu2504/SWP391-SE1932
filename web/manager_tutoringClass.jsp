                    ...
                    <div class="mt-1">
                        <img id="courseImagePreview"
                             src="<c:choose>
                                 ...
                                 <c:otherwise>
                                     ${pageContext.request.contextPath}/images/default/no-image.png
        ...
        <div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full min-w-[1000px] border-collapse bg-white rounded-lg shadow-sm text-sm">
                    <thead>
                        <tr class="bg-blue-600 text-white whitespace-nowrap">
                            <th class="p-3 text-left">Ảnh</th>
                            <th class="p-3 text-left min-w-[120px]">Tên</th>
                            <th class="p-3 text-left max-w-[200px]">Mô Tả</th>
                            <th class="p-3 text-left">Khối</th>
                            <th class="p-3 text-left">Môn</th>
                            <th class="p-3 text-left">Loại</th>
                            <th class="p-3 text-left">Bắt Đầu</th>
                            <th class="p-3 text-left">Kết Thúc</th>
                            <th class="p-3 text-right">Giá (VND)</th>
        ...
        <div class="mt-1 flex items-center">
          <div class="mr-4">
            <img id="editCourseImagePreview"
                 ...
                 alt="Course preview"
                 class="max-h-28 rounded-md object-contain border border-gray-300"
                 onerror="this.src='${pageContext.request.contextPath}/images/default/no-image.png';">
          </div>
          <div>
  ...
  function openEditClassModal(button) {
    ...
    if (image && image.trim() !== '') {
      ...
      preview.onerror = function() {
        ...
        this.src = contextPath + "/images/default/no-image.png";
      };
    } else {
      preview.src = contextPath + "/images/default/no-image.png";
    }
