...
<html lang="en">
    ...
    <body id="top">
        ...
        <div class="reset-container">
            <h2 class="forgot-title">Đặt lại mật khẩu</h2>

            <form action="resetpass" method="post">
                <input type="hidden" name="token" value="${token}" />

                <label for="newPassword" class="lablecolor">Mật khẩu mới:</label>
                <input type="password" id="newPassword" name="newPassword" class="forgot-input" required />
                <br>
                <label for="confirmPassword" class="lablecolor">Nhập lại mật khẩu mới:</label>
                <input type="password" id="confirmPassword" name="confirmPassword" class="forgot-input" required />
