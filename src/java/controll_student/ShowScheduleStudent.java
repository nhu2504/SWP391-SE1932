 ...
 * @author NGOC ANH
 */
@WebServlet(name="ShowScheduleStudent", urlPatterns={"/showschedulestudent"})
public class ShowScheduleStudent extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ShowScheduleStudent</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ShowScheduleStudent at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
