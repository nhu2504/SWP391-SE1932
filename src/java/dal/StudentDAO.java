 ...
 * 
 * Mô tả: DAO này xử lý các thao tác truy vấn liên quan đến học sinh, bao gồm top học sinh, tổng số lượng học sinh và thống kê học sinh theo môn học.
 */
public class StudentDAO {
     ...
     * 
     * Điều kiện lọc:
     * - Vai trò là học sinh (roleID = 3)
     * - Có comment và rating >= 4
     * - Có chứng chỉ không rỗng
     * 
     * Sắp xếp theo:
     * - Đánh giá giảm dần
     * - Số lượng thành tích (tính bằng số dấu chấm trong chuỗi certi)
     * - Ngày comment gần nhất
     * 
     * @return Danh sách Map đại diện cho học sinh, mỗi Map chứa thông tin như tên, avatar, chứng chỉ, đánh giá...
     */
     ...
     * 
     * Cách đếm:
     * - Từ bảng Subjects -> TutoringClass -> ClassGroup -> ClassGroup_Student
     * - Đếm số học sinh đang tham gia lớp của từng môn
     * 
     * @return Danh sách Object[] gồm: [0] = Tên môn học, [1] = Số lượng học sinh
     */
